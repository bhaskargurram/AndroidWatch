...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements DataApi.DataListener, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onConnected(@Nullable Bundle bundle) {
        Log.d("bhaskar", "onConnected in Sunshine Sync Adapter" + bundle);
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    Bitmap toWearIcon = BitmapFactory.decodeResource(resources, iconId);
                    sendPhoto(toAsset(toWearIcon));
    ...
    private void sendPhoto(Asset asset) {
        Log.d("bhaskar", "google api connected " + mGoogleApiClient.isConnected());
        Log.d("bhaskar", "high=" + highest);
        Log.d("bhaskar", "low=" + lowest);
        PutDataMapRequest dataMap = PutDataMapRequest.create(IMAGE_PATH);
        dataMap.getDataMap().putAsset(IMAGE_KEY, asset);
        dataMap.getDataMap().putDouble("high", highest);
        dataMap.getDataMap().putDouble("low", lowest);
        ...
        Wearable.DataApi.putDataItem(mGoogleApiClient, request)
                .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                    ...
                    public void onResult(DataApi.DataItemResult dataItemResult) {
                        Log.d("bhaskar", "Sending image was successful: " + dataItemResult.getStatus()
                                .isSuccess());
                    }
                });
    }
